...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A handmade birthday journey — made with love, for the most bold and beautiful sister." },
      { property: "og:title", content: "A Little Birthday Surprise" },
      { property: "og:description", content: "A handmade birthday journey — made with love." },
